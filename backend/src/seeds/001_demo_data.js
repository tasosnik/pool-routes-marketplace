...
exports.seed = async function(knex) {
  ...
  await knex('users').insert([
    {
      ...
      password_hash: '$2a$12$h2XooFbTnDD52/8RCzb9HOtko2E3W9EtRSgd/DBtl21U3MuqHSIYK', // password123
      first_name: 'Admin',
      last_name: 'User',
      phone: '+1-555-0100',
  ...
  await knex('routes').insert([
    {
      ...
      service_area_center: JSON.stringify({ latitude: 34.0736, longitude: -118.4004 }),
      service_area_radius: 5.0,
      total_accounts: 2,
      active_accounts: 2,
      monthly_revenue: 1150.00,
      average_rate: 575.00,
      is_for_sale: false,
      status: 'active',
      created_at: new Date(),
    ...
    },
    {
      ...
      service_area_center: JSON.stringify({ latitude: 34.0195, longitude: -118.4912 }),
      service_area_radius: 3.5,
      total_accounts: 2,
      active_accounts: 2,
      monthly_revenue: 775.00,
      average_rate: 387.50,
      is_for_sale: false,
      status: 'active',
      created_at: new Date(),
    ...
    },
    {
      ...
      service_area_center: JSON.stringify({ latitude: 34.1478, longitude: -118.1445 }),
  ...
  const beverly_hills_accounts = [
    {
      ...
      state: 'CA',
      zip_code: '90210',
      coordinates: JSON.stringify({ latitude: 34.0837, longitude: -118.4009 }),
      service_type: 'weekly',
      frequency: 'weekly',
      monthly_rate: 600.00,
      pool_type: 'saltwater',
    ...
    },
    {
      ...
      state: 'CA',
      zip_code: '90210',
      coordinates: JSON.stringify({ latitude: 34.0797, longitude: -118.4089 }),
      service_type: 'weekly',
      frequency: 'weekly',
      monthly_rate: 550.00,
      pool_type: 'chlorine',
  ...
  const santa_monica_accounts = [
    {
      ...
      state: 'CA',
      zip_code: '90401',
      coordinates: JSON.stringify({ latitude: 34.0194, longitude: -118.4950 }),
      service_type: 'weekly',
      frequency: 'weekly',
      monthly_rate: 475.00,
      pool_type: 'chlorine',
    ...
    },
    {
      ...
      state: 'CA',
      zip_code: '90405',
      coordinates: JSON.stringify({ latitude: 34.0052, longitude: -118.4873 }),
  ...
  const pasadena_accounts = [
    {
      ...
      state: 'CA',
      zip_code: '91104',
      coordinates: JSON.stringify({ latitude: 34.1581, longitude: -118.1306 }),
      service_type: 'weekly',
      frequency: 'weekly',
      monthly_rate: 525.00,
      pool_type: 'chlorine',
    ...
    },
    {
      ...
      state: 'CA',
      zip_code: '91107',
      coordinates: JSON.stringify({ latitude: 34.1466, longitude: -118.1089 }),
      service_type: 'weekly',
      frequency: 'weekly',
      monthly_rate: 475.00,
      pool_type: 'saltwater',
  ...
  await knex('route_listings').insert([
    {
      ...
      title: 'Established Pasadena Pool Route - 2 Accounts',
      description: 'Well-maintained pool service route in Pasadena with 2 loyal customers. Strong recurring revenue and excellent customer retention. Perfect for expanding your existing operations or starting a new business in the San Gabriel Valley.',
  ...
  accounts.forEach(account => {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      paymentHistory.push({
        id: `990e8400-e29b-41d4-a716-${String(accounts.indexOf(account) * 100 + i).padStart(12, '0')}`,
